...
rem todo uncomment these so they run
echo running Cit-HepPh with different p values
rem call RunMultiplePerfTests "%cluster_output%\QualityClusterSizeCit.csv" 10000 -CI mgraph "%cluster_datasets%\Cit-HepPh.txt"
echo running higgs-reply_network with different p values
rem call RunMultiplePerfTests "%cluster_output%\QualityClusterSizehiggs.csv" 10000 -CI mgraph "%cluster_datasets%\higgs-reply_network.edgelist"
echo running web-NotreDame with different p values
rem call RunMultiplePerfTests "%cluster_output%\QualityClusterSizeNotreDame.csv" 10000 -CI mgraph "%cluster_datasets%\web-NotreDame.txt"
